...
(function($) {
    $.fn.ashtml5lightbox = function(options) {
        ...
        inst.options = $.extend({
            ...
            jsfolder: "",
            skinsfoldername: "",
            loadingimage: "assets/js/product-slider/lightbox-loading.gif",
            nextimage: "assets/js/product-slider/lightbox-next.png",
            previmage: "assets/js/product-slider/lightbox-prev.png",
            closeimage: "assets/js/product-slider/lightbox-close.png",
            playvideoimage: "assets/js/product-slider/lightbox-playvideo.png",
            titlebgimage: "assets/js/product-slider/lightbox-titlebg.png",
            ...
            showplaybutton: true,
            playimage: "assets/js/product-slider/lightbox-play.png",
            pauseimage: "assets/js/product-slider/lightbox-pause.png",
            fullscreenmode: false,
            fullscreencloseimage: "assets/js/product-slider/lightbox-close-fullscreen.png",
            fullscreennextimage: "assets/js/product-slider/lightbox-next-fullscreen.png",
            fullscreenprevimage: "assets/js/product-slider/lightbox-prev-fullscreen.png",
        ...
        if (inst.options.initvimeo) {
            ...
            tag.src = inst.options.jsfolder + "assets/js/product-slider/froogaloop2.min.js";
        ...
        inst.createMarkup = function() {
            ...
            if (inst.options.closeonoverlay) $("#html5-lightbox-overlay", inst.$lightbox).on("click", inst.finish);
            inst.$close.on("click", inst.finish);
                ...
                for (i = 0; i < inst.elemArray.length; i++)
                    if (inst.matchGroup(group, inst.elemArray[i][ELEM_GROUP]))
                        if (inst.elemArray[i][ELEM_THUMBNAIL] && inst.elemArray[i][ELEM_THUMBNAIL].length > 0) {
                            ...
                            index++
                        } $(".html5-nav-thumb").on("mouseover",function() {
                    $(this).css({
                        opacity: 1
                    });
                    $(this).css({
        ...
        inst.off("click").on("click", inst.clickHandler);
        inst.each(function() {
            var self = $(this);
    ...
    $.fn.amazingslider = function(options) {
        ...
        AmazingSlider.prototype = {
            ...
            showSocial: function() {
                ...
                if (this.options.socialmode == "mouseover") $(".amazingslider-wrapper-" + this.id, this.container).on("mouseover",function() {
                ...
                $(".amazingslider-social-btn", this.container).on( "click", function() {
            ...
            createSliderTimeout: function() {
                ...
                this.sliderTimeout = new ASliderTimer(this.options.slideinterval, function() {
                    ...
                    null);
                if (instance.options.pauseonmouseover) $(".amazingslider-slider-" + this.id, this.container).on("mouseover",function() {
            ...
            createMarkup: function() {
                ...
                $(".amazingslider-play-" + this.id, this.container).on( "click", function() {
                ...
                this.container.on("amazingslider.switchtext", function(event, prev, cur) {
                    ...
                    if (instance.textoptions.textstyle == "static") {
                        ...
                        if (instance.textoptions.textautohide) $(".amazingslider-slider-" +
                            instance.id, instance.container).on("mouseover", instance.showTexteffect, instance.hideTexteffect);
            ...
            createNav: function() {
                ...
                if (this.options.navstyle != "none") {
                    ...
                    if (instance.options.navthumbnavigationstyle == "auto") $nav.mousemove(function(e) {
                        ...
                        $carLeftArrow.on("mouseover",function() {
                        ...
                        $carLeftArrow.on( "click", function() {
                        ...
                        $carRightArrow.on("mouseover",function() {
                            if (!$(this).data("disabled")) $(this).css({
                        ...
                        $carRightArrow.on( "click", function() {
                ...
                if (this.options.navshowbuttons) {
                    ...
                    if (this.options.navshowplaypause) {
                        ...
                        $navPause.on("mouseover",function() {
                                if (instance.options.navbuttonhighlightcolor) $(this).css({
                                    "background-color": instance.options.navbuttonhighlightcolor
                                });
                                if (instance.options.navarrowimage) $(this).css({
                    ...
                    $(imgLoader).on("load", function() {
                        ...
                        if (instance.options.navthumbstyle != "textonly") {
                            ...
                            if (this.width / this.height <= instance.options.navimagewidth / instance.options.navimageheight) style = "max-width:none !important;width:100%;height:auto;margin-top:-" +
                                Math.floor(this.height / this.width * instance.options.navimagewidth / 2 - instance.options.navimageheight / 2) + "px";
        ...
        for (var key in options)
            ...
            var defaultOptions = {
                ...
                wtextcssdefault: "font:12px Arial,Tahoma,Helvetica,sans-serif;color:#666;padding:2px 4px;-webkit-border-radius:2px;-moz-border-radius:2px;border-radius:2px;background-color:#fff;opacity:0;filter:alpha(opacity=90);",
